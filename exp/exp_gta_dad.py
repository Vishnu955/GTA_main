...
class Exp_GTA_DAD(Exp_Basic):
    ...
    def _get_data(self, flag):
        ...
        print("features args",args.features)
        self.data_set = Data(
        ...
        print("flag, length of dataset",flag, len(self.data_set))
        self.data_loader = DataLoader(
            ...
            drop_last=drop_last)
        print("data_loader which is taken as train_loader: ", self.data_loader)
        #return self.transform(self.x_data[index]), self.transform(self.y_data[index]) 
        data_set_array = np.array(self.transform(self.data_set))
        data_loader_array = np.array(self.transform(self.data_loader))

        return data_set_array, data_loader_array
        #return self.transform(self.data_set), self.transform(self.data_loader)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            print("Train_loader typet: *************",type(train_loader),"**************")
